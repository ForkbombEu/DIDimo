...
import credentialissuer "github.com/forkbombeu/credimi/pkg/credential_issuer"

const (
	FidesIssuersUrl      = "https://credential-catalog.fides.community/api/public/credentialtype?includeAllDetails=false&size=200"
