var filtrex = (function (t) {
          ...
          parse: function (t) {
            ...
            for (var y, p, d, g, m, b, v, w, _, x, S = {}; ; ) {
              if (
                ...
                if (3 == u) {
                  if (1 == y) throw new Error(k || "Parsing halted.");
                  (c = this.lexer.yyleng),
                    (s = this.lexer.yytext),
  ...
  var P,
    T = {
      isfn: function (t, e) {
        return k(t, e) && "function" == typeof t[e];
      },
      unknown: function (t) {
        throw new v(t);
      },
  ...
  return (
    ...
    (t.compileExpression = function (t, e) {
      ...
      if (c)
        for (var x = 0, S = Object.keys(c); x < S.length; x++) {
          var O = S[x];
          m[O] = c[O];
        }
      ...
      var E = I(b.parse(t));
      function j(t, e, n) {
        if (k(null != e ? e : {}, t)) return e[t];
        throw new w(t);
      }
      function P(t, e) {
        var n = t.name,
          r = t.type;
        return "unescaped" === r && k(s, n) ? s[n] : j(n, e, r);
      }
      E.unshift("return "),
        E.push(";"),
        "function" == typeof a &&
          ...
          return R(
            ...
            function (t) {
              for (
                ...
                o[i - 1] = arguments[i];
              if (k(e, n) && "function" == typeof e[n]) return e[n].apply(e, o);
              throw new v(n);
            }),
            c,
            T,
    ...
    (t.useDotAccessOperator = function (t, e, n, r) {
      ...
      try {
        for (i.s(); !(o = i.n()).done; ) {
          var a,
            c = o.value;
          if (!k(null !== (a = n) && void 0 !== a ? a : {}, c)) throw new w(c);
          n = n[c];
        }
      } catch (t) {
        i.e(t);
